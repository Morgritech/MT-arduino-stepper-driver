...
constexpr float kSweepAngle_degrees = 3600.0F; // 3600/360 = 10 revolutions sweep angle.
// Speed.
constexpr float kSpeed_RPM = 150.0F; ///< Rotation speed (RPM).
// Acceleration/deceleration.
constexpr float kAcceleration_microsteps_per_s_per_s = 7000.0; ///< Acceleration (microsteps per second-squared).
