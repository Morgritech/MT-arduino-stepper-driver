...
/// Speed.
double kSpeed_RPM = 20.0; ///< Rotation speed (RPM).
/// @}
...
void loop() {
  ...
  static float sweep_angle_degrees = kSweepAngleDegrees;
  // Variable to keep track of the motion status.
  static mt::StepperDriver::MotionStatus motion_status;

  // Move the motor.
  motion_status = stepper_driver_.MoveByAngle(sweep_angle_degrees, mt::StepperDriver::AngleUnits::kDegrees, mt::StepperDriver::MotionType::kRelative); // This must be called periodically.
